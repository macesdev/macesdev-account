      ...
      <ul class="space-y-2">
        <div class="mb-4 flex items-center space-x-3">
          <div class="relative">
            <img
              ...
              src="https://raw.githubusercontent.com/macesdev/macesdev-social/maces/w/mamiiblt/mamiiblt.jpg"
              alt=""
            />
            <span
        ...
        <div>
          <li v-if="selectedPage == 'services'">
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Servisler</span>
              <span
        ...
        <div>
          <li v-if="selectedPage == 'notifications'">
            ...
            >
              <svg
                class="flex-shrink-0 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:-900 dark:group-hover:text-white"
                fill="currentColor"
                viewBox="0 0 20 20"
                xmlns="http://www.w3.org/2000/svg"
              >
      ...
      >
        <li>
          ...
          >
            ...
            <span class="ml-3">${m_admin_panel}</span>
          </a>
        </li>
